						...
						{!genres || genres.length === 0 ? (
							<TableRow>
								...
								>
									...
									/>
									<Typography variant="body2">No genres found</Typography>
								</TableCell>
							</TableRow>
						) : (
							genres.map(genre => (
								...
								>
									<TableCell sx={{ fontWeight: 500 }}>{genre.name}</TableCell>
									...
									<TableCell>
										<Chip
											label={`${genre.moviesCount || 0} movies`}
											size="small"
											variant="outlined"
											color={genre.moviesCount > 0 ? 'primary' : 'default'}
											sx={{
												fontWeight: 600,
												fontSize: '0.75rem',
												height: 22,
